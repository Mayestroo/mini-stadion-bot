    ...
    <>
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 700, margin: "0 auto" }}>
          ...
          >
            Mini futbol stadionlarini toping, narxlarni solishtiring va online bron qiling
          </p>
      ...
      <footer style={{ backgroundColor: "var(--color-text-primary)", color: "white", padding: "40px 20px", marginTop: 40 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 24 }}>
            <a href="https://t.me/sportly_bot" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: 14 }}>Telegram Bot</a>
